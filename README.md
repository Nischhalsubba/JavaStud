...
**Branch-aware technical guide for [`release`](https://github.com/Nischhalsubba/JavaStud/tree/release)**

<p><img alt="branch: release" src="https://img.shields.io/static/v1?label=&message=branch%3A%20release&color=5965F2&style=flat-square"> <img alt="Java" src="https://img.shields.io/static/v1?label=&message=Java&color=24292F&style=flat-square"> <img alt="docs: branch-aware" src="https://img.shields.io/static/v1?label=&message=docs%3A%20branch-aware&color=8250DF&style=flat-square"></p>

<p>
  <a href="https://github.com/Nischhalsubba/JavaStud/tree/release"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/JavaStud/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/JavaStud/codespaces/new?ref=release"><strong>Open in Codespaces</strong></a>
</p>

</div>

> [!IMPORTANT]
> This guide is generated from the files actually present on `release`. It links to detected source paths, preserves project-authored notes, and avoids claiming components that were not found.
...
- [`.settings/org.eclipse.core.resources.prefs`](https://github.com/Nischhalsubba/JavaStud/blob/release/.settings/org.eclipse.core.resources.prefs)
- [`README.md`](https://github.com/Nischhalsubba/JavaStud/blob/release/README.md)
- [`src/Area.java`](https://github.com/Nischhalsubba/JavaStud/blob/release/src/Area.java)
- [`src/ArgsMain.java`](https://github.com/Nischhalsubba/JavaStud/blob/release/src/ArgsMain.java)
- [`src/CharDemo.java`](https://github.com/Nischhalsubba/JavaStud/blob/release/src/CharDemo.java)
- [`src/Course.java`](https://github.com/Nischhalsubba/JavaStud/blob/release/src/Course.java)
- [`src/DataTypePreSuf.java`](https://github.com/Nischhalsubba/JavaStud/blob/release/src/DataTypePreSuf.java)
- [`src/Elapsed.java`](https://github.com/Nischhalsubba/JavaStud/blob/release/src/Elapsed.java)
- [`src/ExecDemo.java`](https://github.com/Nischhalsubba/JavaStud/blob/release/src/ExecDemo.java)
- [`src/HELLO.java`](https://github.com/Nischhalsubba/JavaStud/blob/release/src/HELLO.java)
- [`src/HelloWorld.java`](https://github.com/Nischhalsubba/JavaStud/blob/release/src/HelloWorld.java)
- [`src/HelloWorldDialog.java`](https://github.com/Nischhalsubba/JavaStud/blob/release/src/HelloWorldDialog.java)
...
|---|---|
| Interface | [`src`](https://github.com/Nischhalsubba/JavaStud/tree/release/src) |
...
```mermaid
flowchart LR
    CHANGE["Change on release"] --> CHECK["Tests and quality checks"]
